		...
		if (!isProduction) {
			templateConfig.projectpage.enable
				? (menu += `<li><hr></li><li><a target="_blank" href="${templateConfig.projectpage.template.replace(
						'src',
						''
				  )}">Шаблон страницы проекта</a></li>`)
				: '';
			isIconFont
				? (menu += `<li><hr></li><li><a target="_blank" href="/assets/svgicons/preview/iconfont.html">Иконочный шрифт</a></li>`)
				: '';
			templateConfig.devcomponents.enable
				? (menu += `<li><hr></li><li><a target="_blank" href="${templateConfig.devcomponents.filename}">Разработка компонентов</a></li>`)
				: '';
		}
		menu += `</ul>`;
		menu += `<style>
