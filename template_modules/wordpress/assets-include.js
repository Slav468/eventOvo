...
export default function wpAssetsInclude() {
	...
	if (isProduction) {
		const jsFiles = globSync(
			`src/components/wordpress/fls-theme/build/assets/js/*.js`
		);
		const cssFiles = globSync(
			`src/components/wordpress/fls-theme/build/assets/css/*.css`
		);
		...
		fs.writeFileSync(
			`src/components/wordpress/fls-theme/build/assets/js/custom.js`,
			''
		);
		fs.writeFileSync(
			`src/components/wordpress/fls-theme/build/assets/css/custom.css`,
			''
		);
